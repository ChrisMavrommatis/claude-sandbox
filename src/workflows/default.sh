...
BANNER
    ...
    echo ""
    printf "  ${C}Claude${N}\n"
    printf "    claude                                     Interactive session\n"
    printf "    claude -c                                  Continue last conversation\n"
    printf "    claude -r                                  Resume a past conversation\n"
    printf "    claude -p \"prompt\"                         Non-interactive / pipe mode\n"
    printf "    claude -w                                  New git worktree session\n"
    printf "    claude --model sonnet                      Override model\n"
    printf "    claude --permission-mode plan              Plan only, no edits\n"
    printf "    claude --permission-mode acceptEdits       Auto-accept edits\n"
    printf "    claude --dangerously-skip-permissions      Bypass all permission prompts\n"
    echo ""
}
_welcome