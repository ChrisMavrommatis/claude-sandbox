...
| `Test-Sandbox` | Verifies installation and security posture (26 checks) |
...
| `plans/security-posture-details.md` | Detailed security analysis: 12 controls in place, 12 identified gaps with severity |
...
- `Install-Sandbox.ps1` - `[I-001]` through `[I-012]`, `[S-001]` through `[S-008]`, `[S-013]` where each resource is created
- `wsl.conf` - security settings annotated inline with `[S-001]` through `[S-006]`, `[S-014]`
- `workflows/default.sh` - `[S-012]` on project name validation
- `Set-SandboxProfile.ps1` - `[I-006]`
- `Set-SandboxWorkflow.ps1` - `[I-007]` and `[I-011]`
